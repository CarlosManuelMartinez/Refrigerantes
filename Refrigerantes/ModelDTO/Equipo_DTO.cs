...
namespace Refrigerantes.ModelDTO
{
    public class Equipo_DTO
    {
        ...
        public Equipo_DTO(int equipoId, int instalacionId, int refrigeranteId, int tipoEquipoId, string marca, string modelo, decimal cargaRefrigerante, Instalacion instalacion, List<OperacionCarga> operacionCargas, Refrigerante refrigerante, TipoEquipo tipoEquipo)
        {
            EquipoId = equipoId;
